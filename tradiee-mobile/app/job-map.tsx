...
const styles = StyleSheet.create({
  ...
  count: { marginLeft: 'auto', fontSize: 12, color: '#6b7280' },
  mapBox: { height: 280, marginHorizontal: 12, borderRadius: 14, overflow: 'hidden', backgroundColor: '#e5e7eb' },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  list: { flex: 1 },
  empty: { color: '#6b7280', fontSize: 14, textAlign: 'center', padding: 24 },
  ...
  cardNum: { fontSize: 11, color: '#6b7280', fontWeight: '600' },
  notOnMap: { fontSize: 10, fontWeight: '600', color: '#6b7280', backgroundColor: '#f3f4f6', paddingHorizontal: 6, paddingVertical: 1, borderRadius: 6, overflow: 'hidden' },
