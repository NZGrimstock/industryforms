...
const s = StyleSheet.create({
  ...
  statLbl: { fontSize: 11, color: '#6b7280', fontWeight: '500', marginTop: 2, textAlign: 'center' },
  ...
  moneyLbl: { fontSize: 11, color: '#6b7280', fontWeight: '600' },
  ...
  visitTime: { fontSize: 12, color: '#6b7280', fontWeight: '600' },
  visitTitle: { fontSize: 15, fontWeight: '600', color: '#111827' },
  visitCustomer: { fontSize: 12, color: '#6b7280' },
  visitNum: { fontSize: 11, color: '#6b7280', fontWeight: '600' },
